...
import BiCurrentLocation from '../../../icons/bx-current-location.svg?react'
import FiX from '../../../icons/x.svg?react'
...
const LocationSelector: React.FC = () => {
  ...
  const { selectedIndex, setSelectedIndex, handleRovingKeyDown } = useRovingSelection(
    suggestions.length,
  )
